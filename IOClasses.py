...
# Kenny Lu, 2020-Mar-23, Added code to support a list of files
#------------------------------------------#
...
class FileIO:
    ...
    """
    @staticmethod
    def save_inventory(file_name: list, lst_Inventory: list):
        """
        ...
        # Added method to accept a list of file names.
        ...
        try:
            ...
            # Added code to save track data to file
    ...
    @staticmethod
    def load_inventory(file_name: list):
        """
...
class ScreenIO:
    ...
    def menu_CD_choice():
        ...
        Returns:
            choice (string): a lower case string of the users input out of the chocies a, d, r, or x 
    ...
    def get_CD_info():
        ...
        """
        while True:
            str_cdId = input('Enter ID (Integer only): ').strip()
            if str_cdId.lower() == 'exit':
                break
            try:
                cdId = int(str_cdId)
    ...
    def get_track_info():
        ...
        while True:
            str_trkId = input('Enter Position on CD / Album (Integer only): ').strip() 
            if str_trkId.lower() == 'exit':
                break
            try:
                trkId = int(str_trkId)
            except ValueError as e:
