...
# Kenny Lu, 2020-Mar-23, Added submenu to handle tracks
#------------------------------------------#
    ...
    if strChoice == 'l':
        ...
        while True:
            ...
            if strChoice == 'a':
                ...
                IO.ScreenIO.show_tracks(cd)
                str_trk_idx = input('Select the Track index: ')
                try:
                    trk_idx = int(str_trk_idx) 
                except ValueError:
                    print("Oops! Please enter integer only. Try again or type \'x\' to return to the menu.")  
                continue
